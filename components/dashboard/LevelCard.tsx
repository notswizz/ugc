  ...
  return (
    <Card className="border border-gray-200 shadow-sm bg-white">
      <CardHeader className="pb-3 pt-4 px-5">
        <CardTitle className="text-sm font-bold text-gray-900">Level {level} — {title}</CardTitle>
      </CardHeader>
        ...
        <div className="space-y-3">
          ...
          {level < 7 && (
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                <div 
                  className="bg-gradient-to-r from-brand-600 to-accent-600 h-2 rounded-full transition-all duration-300"
          ...
          <div className="pt-3 border-t border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-semibold text-gray-900">Daily Streak</p>
                <p className="text-xs text-gray-500">Complete 1 job today for +10 bonus rep</p>
              </div>
