          ...
          <div className="fixed inset-0 overflow-hidden bg-gradient-to-br from-purple-900 via-pink-900 to-orange-900">
            ...
            <div className="relative flex flex-col items-center justify-center min-h-screen text-center px-4">
              ...
              <div className="relative mb-12">
                {/* Outer ring */}
                <div className="absolute inset-0 rounded-full border-4 border-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-spin" style={{ width: '200px', height: '200px', margin: '-100px', animationDuration: '3s' }}></div>
                {/* Middle ring */}
                <div className="absolute inset-0 rounded-full border-4 border-transparent bg-gradient-to-r from-pink-500 via-orange-500 to-blue-500 animate-spin" style={{ width: '160px', height: '160px', margin: '-80px', animationDuration: '2s', animationDirection: 'reverse' }}></div>
                {/* Inner ring */}
                <div className="absolute inset-0 rounded-full border-4 border-transparent bg-gradient-to-r from-purple-500 via-blue-500 to-cyan-500 animate-spin" style={{ width: '120px', height: '120px', margin: '-60px', animationDuration: '1.5s' }}></div>
                
                {/* Center pulsing orb */}
                <div className="relative w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-blue-400 via-purple-400 to-pink-400 shadow-2xl animate-pulse" style={{ boxShadow: '0 0 60px rgba(139, 92, 246, 0.6), 0 0 100px rgba(236, 72, 153, 0.4)' }}>
                  <div className="absolute inset-0 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 opacity-75 animate-ping" style={{ animationDuration: '2s' }}></div>
